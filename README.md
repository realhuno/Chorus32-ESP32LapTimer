 ...
 * Currently the initial power state of the modules is of, if the voltage reading is below 6V (this is due to protect my already bad USB-Port during developement)
